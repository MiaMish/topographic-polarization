...
class Simulation(ABC):
    ...
    def _truncate_opinion(self, opinion_of_agent_to_switch: float) -> float:
        # TODO: I'm not sure if it's the right logic... Consider other options.
        opinion = random.normal(opinion_of_agent_to_switch, self.simulation_config.switch_agent_sigma)
    ...
    def run_simulation(self) -> SimulationResult:
        ...
        for iteration in range(1, self.simulation_config.num_iterations):
